...
// ----------------------------------------------------------------------------
// Devolve a URL do objeto na Connected Cloud. Nunca expomos o caminho físico;
// o acesso é filtrado pelo Access Guard antes de libertar a URL. Sem
// Firebase Storage.
// ============================================================================
...
export async function getUrl(key: string): Promise<string> {
  return connectedStorage.signedUrl(key);
}
